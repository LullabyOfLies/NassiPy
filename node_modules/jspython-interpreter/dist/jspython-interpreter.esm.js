...
function findOperators(tokens, operationType) {
    ...
    return !operationType
        ? findTokenValueIndexes(tokens, function (value) { return OperatorsMap[value] !== undefined; })
...
var Parser = /** @class */ (function () {
    ...
    Parser.prototype.createExpressionNode = function (tokens) {
        ...
        // create Array Node
        if (getTokenValue(tokens[0]) === '[' && getTokenValue(tokens[tokens.length - 1]) === ']') {
            var items = splitTokens(tokens.splice(1, tokens.length - 2), ',').map(function (tkns) {
                return _this.createExpressionNode(tkns);
            });
